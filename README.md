...
4. При первом запуске нажмите на **шестеренку ⚙️ (Настройки)** и укажите:
   ...
   - Ваш бесплатный API ключ от CurseForge (получить его можно на [console.curseforge.com](https://console.curseforge.com/), зарегистрировавшись и создав ключ во вкладке **API Keys**).
